...
# -*- coding: utf-8 -*-
#
# invaders documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = 'invaders'
copyright = 'Woosang Lee <recollect12@gmail.com>'
author = 'Woosang Lee <recollect12@gmail.com>'
...
latex_documents = [
    (master_doc, 'invaders.tex', 'invaders Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'invaders', 'invaders Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'invaders', 'invaders Documentation',
     author, 'invaders', 'One line description of project.',
     'Miscellaneous'),
]
